...
# Fix Gr7_22_E2_edited.json
print("Fixing all Gr7_22_E2_edited.json question endings...")
with open('edited_by_tag/Gr7_22_E2/Gr7_22_E2_edited.json', 'r', encoding='utf-8') as f:
    data = json.load(f)
...
with open('edited_by_tag/Gr7_22_E2/Gr7_22_E2_edited.json', 'w', encoding='utf-8') as f:
