...
def fix_question_formatting(text):
    """Fix the question text to have proper LaTeX formatting with correct dollar sign closures"""
    ...
    if match:
        ...
        # Create properly formatted question with each math expression properly enclosed
        # Blanks are kept as _____ outside of dollar signs
