...
import re
input_file = "miniRawURLS.csv"
output_file = "miniLinks.csv"
videos = {}
pattern = r"/embed/([^/?]+)"
with open(input_file, newline="") as csv_in, open("miniTag.csv", "r") as tag_file, open(output_file, "w", newline="") as csv_out:
