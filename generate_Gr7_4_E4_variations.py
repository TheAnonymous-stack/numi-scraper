...
def load_templates():
    """Load templates for tag Gr7_4_E4"""
    with open('C:/Users/kapil/numi-scraper/file_fixed.json', 'r') as f:
        all_templates = json.load(f)

    # Filter for specific tag
    return [t for t in all_templates if t.get('tag') == 'Gr7_4_E4']

def generate_variations():
    """Generate 50 variations for Gr7_4_E4"""
    templates = load_templates()

    if not templates:
        print("No templates found for tag Gr7_4_E4")
        return []
...
def save_variations(variations):
    ...
    filename = 'C:/Users/kapil/numi-scraper/Gr7_4_E4 variations.json'
    with open(filename, 'w') as f:
        json.dump(variations, f, indent=2)
    print(f"Generated {len(variations)} variations for Gr7_4_E4")
