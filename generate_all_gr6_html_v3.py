...
def generate_number_line(description):
    ...
    for i in range(num_ticks):
        ...
        <text x="{x}" y="70" text-anchor="middle" font-size="12">{label}</text>'''
        ...
        try:
            ...
            if 'quizzes' in data:
                ...
                if questions_with_visuals > 0:
                    ...
                    print(f"  [DONE] Created {files_created_for_exercise} HTML files (found {questions_with_visuals} with visuals, added placeholders to reach 51)")
                else:
...
if __name__ == "__main__":
    ...
    print(f"\n[COMPLETE] Generation complete! Created {files_created} HTML files in the html/ folder.")