...
def scramble_answers(filename):
    ...
    # Set seed for reproducibility but different from previous
    random.seed(123)
...
# Process Gr6_30_E1
scramble_answers('Gr6_30_E1_variations.json')
print("Scrambled answers in Gr6_30_E1_variations.json")