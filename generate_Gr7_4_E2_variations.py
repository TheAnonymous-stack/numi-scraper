...
def load_templates():
    """Load templates for tag Gr7_4_E2"""
    with open('C:/Users/kapil/numi-scraper/file_fixed.json', 'r') as f:
        all_templates = json.load(f)

    # Filter for specific tag
    return [t for t in all_templates if t.get('tag') == 'Gr7_4_E2']

def generate_variations():
    """Generate 50 variations for Gr7_4_E2"""
    templates = load_templates()

    if not templates:
        print("No templates found for tag Gr7_4_E2")
        return []
    ...
    for i in range(2, 52):  # Generate 50 variations (2-51)
        ...
        # Default variation logic - update numeric values
...
def save_variations(variations):
    ...
    filename = 'C:/Users/kapil/numi-scraper/Gr7_4_E2 variations.json'
    with open(filename, 'w') as f:
        json.dump(variations, f, indent=2)
    print(f"Generated {len(variations)} variations for Gr7_4_E2")
